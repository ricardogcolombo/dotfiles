...
--     if vim.lsp.get_active_clients()[1].server_capabilities.document_highlight then
--         vim.api.nvim_exec([[
...
-- -- -- LSPs
-- -- local servers = {"pyright", "rust_analyzer", "gopls", "tsserver", "vimls","terraformls","tflint"}
